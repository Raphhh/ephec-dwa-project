...
#### 1. Appel de JavaScript lors de la soumission
...
On court-circuite le fonctionnement habituel du formulaire pour ne pas rafraîchir la page et passer par JavaScript.
...
À la place, grâce à l'attribut `onclick="updateBasket()"`, le bouton appelle la fonction JavaScript `updateBasket()`, 
laquelle va gérer l'appel AJAX.
